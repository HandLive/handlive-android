...
Kotlin, Gradle KTS, AGP 9.4, Kotlin 2.4, compileSdk 36 / targetSdk 35, Compose. Giao diện đa ngôn ngữ: tiếng Anh mặc định, tiếng Việt là ngôn ngữ thứ hai (chuỗi từ `../shared/strings`, thiết kế chi tiết 0.12). Đặc tả: `../docs/detailed-design/` (kho hub). Kế hoạch: `../plans/20260925-implementation/`.
