...
/**
 * SET-02 fields 28–29 as an action sheet — the warning, the red button that names the action, "Cancel" — and E7
 * as an alert with "Delete" and "Cancel" (design system Alert: SET-02 field 28).
 */
@Composable
